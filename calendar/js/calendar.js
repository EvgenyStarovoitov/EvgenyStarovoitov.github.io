var calendar = {
  month: document.querySelectorAll('.init-month')[0],
  next: document.querySelectorAll('.btn-next')[0],
  prev: document.querySelectorAll('.btn-prev')[0],
  label: document.querySelectorAll('.label-month')[0],
  activeDates: null,
  date: new Date(),
  todaysDate: new Date(),
  ...
  createListeners: function () {
    var _this = this
    //  Clear a calendar and show the next month
    ...
    // Clear a calendar and show the prev month
